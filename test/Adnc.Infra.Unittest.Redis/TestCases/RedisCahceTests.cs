...
public class RedisCahceTests : IClassFixture<RedisContextFixture>
{
    private readonly ITestOutputHelper _output;
    private readonly ICacheProvider _cacheProvider;
    private readonly IRedisProvider _redisProvider;
    private readonly IDistributedLocker _distributedLocker;
    private readonly RedisContextFixture _fixture;

    public RedisCahceTests(RedisContextFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
