...
- 实体/映射/迁移示例：参见 `doc/wiki/feature-dev-guide-zh.md`。
- EF Core 仓储与工作单元：参见 `doc/wiki/efcore-pemelo-curd-zh.md` 与 `doc/wiki/efcore-pemolo-unitofwork-zh.md`。
- 原生 SQL 能力：参见 `doc/wiki/efcore-pemelo-sql-zh.md`。
