...
本文以 `src/Demo/Cust/Api/Application/Subscribers/CustomerRechargedEventSubscriber.cs` 为例，介绍 ADNC 中基于 CAP（DotNetCore.CAP）的事件发布与订阅方式，并与 `doc/wiki/service-http-call-zh.md` 的“同步调用”做出区分。
