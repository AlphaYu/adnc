...
public class UsrGrpcServer : Adnc.Demo.Shared.Remote.Grpc.Services.UsrGrpc.UsrGrpcBase
{
    ...
    private readonly IOrganizationService _deptAppService;
    private readonly UserContext _userContext;
    private readonly IObjectMapper _mapper;

    public UsrGrpcServer(IUserService userService
        , IOrganizationService deptAppService
    ...
    public override async Task<GrpcResponse> GetCurrenUserPermissions(UserPermissionsRequest request, ServerCallContext context)
    {
        ...
        if (request.UserId != _userContext.Id)
        {
            ...
            grpcResponse.Error = @"request.Id != userContext.Id";
            return grpcResponse;
        }
