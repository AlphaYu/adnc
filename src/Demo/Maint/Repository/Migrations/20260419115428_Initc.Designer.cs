...
namespace Adnc.Demo.Maint.Repository.Migrations
{
    ...
    [Migration("20260419115428_Initc")]
    partial class Initc
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Adnc.Shared.Repository.EfCoreEntities.EventTracker", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        ...
                        .HasComment("Creation time / registration time");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_maint_eventtracker");

                    b.HasIndex(new[] { "EventId", "TrackerName" }, "uk_eventid_trackername")
                        .IsUnique()
                        .HasDatabaseName("ix_maint_eventtracker_eventid_trackername");

                    b.ToTable("maint_eventtracker", null, t =>
                        {
                            t.HasComment("Event tracking/processing information");
                        });
                });
