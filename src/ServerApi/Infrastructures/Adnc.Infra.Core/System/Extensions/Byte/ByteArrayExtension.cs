...
public static class ByteArrayExtension
{
    ...
    public static string ToBase64String([NotNull] this byte[] inArray, int offset, int length) => Convert.ToBase64String(inArray, offset, length);
    ...
    /// <param name="options">to insert a line break every 76 characters, or  to not insert line breaks.</param>
    /// <returns>The string representation in base 64 of  elements of , starting at position .</returns>
    public static string ToBase64String([NotNull] this byte[] inArray, int offset, int length, Base64FormattingOptions options) => Convert.ToBase64String(inArray, offset, length, options);
    ...
    /// <summary>
    /// convert to string ,default encoding = Encoding.UTF8
    /// </summary>
    /// <param name="byteArray"></param>
    /// <returns></returns>
    public static string GetString([NotNull] this byte[] byteArray) => byteArray.GetString(Encoding.UTF8);
