...
namespace Adnc.Infra.EfCore.Repositories
{
       ...
       where TEntity : Entity, IEfEntity<long>
    {
        ...
        private Task<int> UpdateInternalAsync(TEntity entity, CancellationToken cancellationToken = default)
        {
            //获取实体状态
...
#pragma warning restore S125 // Sections of code should not be commented out
        ...
        {
            return await this.UpdateInternalAsync(entity, cancellationToken);
        }
