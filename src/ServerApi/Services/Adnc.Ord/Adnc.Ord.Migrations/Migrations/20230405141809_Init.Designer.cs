...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adnc.Ord.Domain.Aggregates.OrderAggregate.Order", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("Adnc.Ord.Domain.Aggregates.OrderAggregate.OrderItem", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("Adnc.Ord.Domain.Aggregates.OrderAggregate.Order", b =>
                {
                    b.OwnsOne("Adnc.Ord.Domain.Aggregates.OrderAggregate.OrderReceiver", "Receiver", b1 =>
                        {
                    ...
                    b.OwnsOne("Adnc.Ord.Domain.Aggregates.OrderAggregate.OrderStatus", "Status", b1 =>
                        {
                            b1.Property<long>("OrderId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Adnc.Ord.Domain.Aggregates.OrderAggregate.OrderItem", b =>
                {
                    b.HasOne("Adnc.Ord.Domain.Aggregates.OrderAggregate.Order", null)
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                    ...
                    b.OwnsOne("Adnc.Ord.Domain.Aggregates.OrderAggregate.OrderItemProduct", "Product", b1 =>
                        {
