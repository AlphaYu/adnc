...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adnc.Whse.Domain.Aggregates.ProductAggregate.Product", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("Adnc.Whse.Domain.Aggregates.WarehouseAggregate.InventoryChangesLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Adnc.Whse.Domain.Aggregates.WarehouseAggregate.Warehouse", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("Adnc.Whse.Domain.Aggregates.ProductAggregate.Product", b =>
                {
                    b.OwnsOne("Adnc.Whse.Domain.Aggregates.ProductAggregate.ProductStatus", "Status", b1 =>
                        {
            ...
            modelBuilder.Entity("Adnc.Whse.Domain.Aggregates.WarehouseAggregate.Warehouse", b =>
                {
                    b.OwnsOne("Adnc.Whse.Domain.Aggregates.WarehouseAggregate.WarehousePosition", "Position", b1 =>
                        {
