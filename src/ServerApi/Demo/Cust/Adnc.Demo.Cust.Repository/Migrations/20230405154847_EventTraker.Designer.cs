...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adnc.Demo.Cust.Repository.Entities.Customer", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("Adnc.Demo.Cust.Repository.Entities.CustomerFinance", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("Adnc.Demo.Cust.Repository.Entities.CustomerTransactionLog", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("Adnc.Demo.Cust.Repository.Entities.CustomerFinance", b =>
                {
                    b.HasOne("Adnc.Demo.Cust.Repository.Entities.Customer", "Customer")
                        .WithOne("FinanceInfo")
                        .HasForeignKey("Adnc.Demo.Cust.Repository.Entities.CustomerFinance", "Id")
            ...
            modelBuilder.Entity("Adnc.Demo.Cust.Repository.Entities.CustomerTransactionLog", b =>
                {
                    b.HasOne("Adnc.Demo.Cust.Repository.Entities.Customer", null)
