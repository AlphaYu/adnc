...
namespace Adnc.Demo.Cust.Repository.Migrations
{
    ...
    [Migration("20221220082556_Init2022122001")]
    partial class Init2022122001
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adnc.Demo.Cust.Entities.Customer", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("Adnc.Demo.Cust.Entities.CustomerFinance", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("Adnc.Demo.Cust.Entities.CustomerTransactionLog", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("Adnc.Demo.Cust.Entities.CustomerFinance", b =>
                {
                    b.HasOne("Adnc.Demo.Cust.Entities.Customer", "Customer")
                        .WithOne("FinanceInfo")
                        .HasForeignKey("Adnc.Demo.Cust.Entities.CustomerFinance", "Id")
            ...
            modelBuilder.Entity("Adnc.Demo.Cust.Entities.CustomerTransactionLog", b =>
                {
                    b.HasOne("Adnc.Demo.Cust.Entities.Customer", null)
