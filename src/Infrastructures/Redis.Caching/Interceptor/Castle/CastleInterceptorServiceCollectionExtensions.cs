...
//using Adnc.Infra.Redis.Core.Configurations;
...
public static class CastleInterceptorServiceCollectionExtensions
{
    ...
    /// <param name="options">Adnc.Infra.Redis Interceptor config</param>
    //public static void ConfigureCastleInterceptor(this IServiceCollection services, Action<Adnc.Infra.RedisInterceptorOptions> options)
    //{
